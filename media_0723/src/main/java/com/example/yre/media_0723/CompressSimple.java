 ...
 *
 */
public class CompressSimple extends Activity {
    ...
    public class TranscdingBackground extends AsyncTask<String, Integer, Integer>
    {
        ...
        protected Integer doInBackground(String... paths) {
            ...
            //String commandStr = "ffmpeg -y -i /sdcard/DCIM/Camera/in.mp4 -strict experimental -s 320x240 -r 30 -aspect 3:4 -ab 48000 -ac 2 -ar 22050 -vcodec mpeg4 -b 2097152 /sdcard/DCIM/Camera/out.mp4";
            //String[] complexCommand = {"ffmpeg", "-y" ,"-i", "/sdcard/DCIM/Camera/in.mp4","-strict","experimental","-s", "160x120","-r","25", "-vcodec", "mpeg4", "-b", "150k", "-ab","48000", "-ac", "2", "-ar", "22050", "/sdcard/DCIM/Camera/out.mp4"};
            ///////////////////////////////////////////////////////////////////////
...
//					commandValidationFailedFlag = true;
        ...
        protected void onPostExecute(Integer result) {
            ...
            CompressSimple.this.runOnUiThread(new Runnable() {
                public void run() {
                    Toast.makeText(CompressSimple.this, status, Toast.LENGTH_LONG).show();
                    if (status.equals("Transcoding Status: Failed")) {
                        Toast.makeText(CompressSimple.this, "Check: " + vkLogPath + " for more information.", Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
